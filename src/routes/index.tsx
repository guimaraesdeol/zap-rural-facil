        ...
        <div className="mx-auto max-w-6xl px-4 py-14 sm:py-32 lg:py-40">
          <div className="max-w-3xl text-white">
            ...
            <p className="mt-4 sm:mt-6 max-w-2xl text-sm sm:text-base leading-loose sm:leading-loose text-white/95 [text-shadow:_0_2px_4px_rgba(0,0,0,0.85)]">
              O Ruralshop é o Shopping do Produtor — encontre tudo o que precisa em um só lugar. Oferecemos uma <strong>linha completa de produtos</strong> para o produtor rural, unindo variedade, qualidade e agilidade no atendimento. Fale conosco pelo WhatsApp e receba seu orçamento na hora!
            </p>
